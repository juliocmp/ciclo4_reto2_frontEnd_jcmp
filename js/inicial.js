function getUser() {
    ...
    $.ajax({
        type: 'GET',
        // url: 'http://localhost:8080/api/user/' + id,         129.151 .121 .96
...
function getOrders() {
    ...
    $.ajax({
        type: 'GET',
        // url: 'http://localhost:8080/api/orders/' + id,   129.151 .121 .96
        url: 'http://129.151.121.96:8080/api/orders/' + id,
        dataType: 'json',
        success: function(data) {
            var $row = $('<tr>');
...
$(document).ready(function() {
    ...
    myModal.addEventListener('shown.bs.modal', function(e) {
        $.ajax({
            type: 'GET',
            // url: 'http://localhost:8080/api/hairproducts/all',    129.151 .121 .96
